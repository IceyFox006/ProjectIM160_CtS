...
public class HUD : MonoBehaviour
{
    ...
    /// </summary>
    public void DisableHUD(bool restartAnimation = false)
    {
        if (restartAnimation)
        {
            _characterMovement.GetComponent<Animator>().Play("DISABLE", 0, 0f);
            _inventory.GetComponent<Animator>().Play("DISABLE", 0, 0f);
            _pauseButton.GetComponent<Animator>().Play("DISABLE", 0, 0f);
        }
        else
        {
