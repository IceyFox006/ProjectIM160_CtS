...
public class InventoryManager : MonoBehaviour
{
    ...
    private static Item currentHoldItemID = null;
    private static int currentSelectedIndex = -1;

    [SerializeField] private Item acorn;
    ...
    public Item Acorn { get => acorn; set => acorn = value; }
    public static Item CurrentHoldItemID { get => currentHoldItemID; set => currentHoldItemID = value; }
    ...
    public void HoldItem(int itemIndex = 0)
    {
        ...
        if (itemIndex < inventoryItems.Count)
        {
            ...
            {
                currentHoldItemID = currentHoldItem.GetComponentInChildren<PickUp>().Item;
