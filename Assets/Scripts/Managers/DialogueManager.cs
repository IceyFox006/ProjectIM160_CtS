...
public class DialogueManager : MonoBehaviour
{
    ...
    public void StartDialogue(Dialogue dialogue)
    {
        ...
        _dialogueUI.GetComponent<Animator>().Play("ENABLE", 0, 0f);
    ...
    public void ActivateEffectFlags(DialogueLine dialogueLine)
    {
        ...
        switch (dialogueLine.EffectFlag)
        {
            ...
            case Enums.EffectFlag.PlayCredits://Goes to credits scene.
                ...
                break;
            case Enums.EffectFlag.End1:
            case Enums.EffectFlag.End2A:
                StaticData.End = Enums.End.Loop;
                break;
            case Enums.EffectFlag.End2B:
                StaticData.End = Enums.End.EliotLeave;
                break;
            case Enums.EffectFlag.End3:
                StaticData.End = Enums.End.Stay;
                break;
        }
    }
}
